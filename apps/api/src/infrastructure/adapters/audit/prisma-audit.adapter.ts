...
import { AuditPort, AppointmentAuditEvent, AuditActor } from '../../../domain/audit/audit.port';

@Injectable()
export class PrismaAuditRepository implements AuditPort<Prisma.TransactionClient> {
